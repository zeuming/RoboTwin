...
class put_ball_into_dustpan(Base_task):
    ...
    def pre_move(self):
        ...
        self.left_move_to_pose_with_screw(pose=pose3,save_freq=None)
        # while 1:
        #     self.close_right_gripper(pos = -0.002)
    ...
    def play_once(self,save_freq=None):
        ...
        #-0.752,0.087, -0.642, -0.126
        # print(self.tabel_tennis.get_pose().p)
        left_pose0 = list(self.tabel_tennis.get_pose().p+[-0.3,-0.1,0])[:2] + [0.955, -0.665,0.092, -0.733, -0.114]
        #-0.543,0.454, -0.454, -0.543
        #  -0.463,0.510,-0.384,-0.615
        right_pose0 = list(self.tabel_tennis.get_pose().p+[0.15,-0.15,0])[:2] + [0.92, -0.398,0.410,-0.455,-0.683]
        self.together_move_to_pose_with_screw(left_target_pose=left_pose0,right_target_pose=right_pose0,save_freq=10)
        # while 1:
        #     self.close_right_gripper(pos = -0.002)
        ...
        self.right_move_to_pose_with_screw(pose=right_pose1,save_freq=20)
        for _ in range(2):
            self._take_picture()
        # while 1:
        #     self.close_right_gripper(pos = -0.002)
