...
class move_bottle(Base_task):
    ...
    def play_once(self,save_freq=None):
        left_pose0 = list(self.box.get_pose().p+[-0.14,-0.18,0.05])+[-0.906,0,0,-0.424]
        left_pose1 = list(self.box.get_pose().p+[-0.08,-0.11,0.05])+[-0.906,0,0,-0.424]
        ...
        right_pick_pose[0]+=0.03
        left_target_pose[0]-=0.03
